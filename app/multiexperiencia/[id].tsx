...
import { ArrowLeft, MapPin, Clock, Route } from 'lucide-react-native';
import {
  ScrollView,
  StyleSheet,
  Text,
    ...
    <View style={styles.container}>
      ...
      >
        ...
        <View style={styles.content}>
          ...
          {(experiencia.tiempo || experiencia.kilometros) && (
            <View style={styles.metaContainer}>
              {experiencia.tiempo && (
                <View style={styles.metaCard}>
                  <Clock size={16} color={COLORS.primary} />
                  <Text style={styles.metaText}>{experiencia.tiempo}</Text>
                </View>
              )}
